...
- On the back of the card, I added two new fields (fields are places to put stuff on an Anki flashcard). Go to Tools/Manage note types, then "Fields" and "Add". I called my two new fields "Target" and "Base". To have them show on the card, go to Tools/Manage note types, then "Cards". Then put the new field names enclosed in double curly braces onto the back of the card. The filed names are case-sensitive. Like this:
