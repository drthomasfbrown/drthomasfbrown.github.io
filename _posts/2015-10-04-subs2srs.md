...
- in "Advanced subtitle options", choose context tab, and increase leading and trailing lines to 1 each, and include audio clip.

5) Set the Avatar deck to add only five new cards a day, so as not to get slammed three weeks in. I study each one carefully until I've learned it (assuming I don't delete or suspend it if I don't like it).
